...
class RiskScoreRangeMappingModelTests(TestCase):
    ...
    def test_inline_and_block_rich_text_are_wrapped(self):
        html = "<p>A</p>Trailing"
        wrapped = RiskScoreRangeMapping._wrap_inline_rich_text(html)
        self.assertEqual(wrapped, "<div><p>A</p>Trailing</div>")
